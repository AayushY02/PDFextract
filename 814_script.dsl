...
「同種工事（企業）」: 
   ...
   if false:
      search in : region_A
      search text : "公告開始日時点までに元請けとして完成し、引渡しが完了した"
      if found : 
         take right : 
            search in : taken
            search text : "ただし、共同企業体"
            if found : 
               take left :
                  search in : taken
                  search text : "を施工した実績を有すること"
                  if found : 
                     take left :
                        store(tempdd)
            search in : taken
...
「同種性が認められる（企業）」:
    ...
    if false : 
        search in : region_B
        search text : "別表1評価項目等について(加算点)"
        if found : 
            take right : 
                search in : taken
                search text : "企 業 の 能 力 等"
                if found : 
                  take right : 
                     search in : taken
                     search text : "技 術 者 の 能 力"
                     if found : 
                        take left : 
                           search in : taken
