...
if name_of != "本官": # 本官以外の場合
  if (("より高い同種性が認められる工事：" in text) or ("高い同種性が認められる工事：" in text)):
    ...
    if ("より高い同種性が認められる工事：" in text0):
      ...
      print("「より高い同種性（企業）」", doushusei_co[0])
    ...
    if ("より高い同種性が認められる工事：" in text0):
      ...
      print("「より高い同種性（技術者）」", doushusei_en[0])
