...
name_bu : 
   search in : all
   search text : "北海道開発局稚内開発建設部"
   if found : 
      set("北海道開発局")

name_of :
   search in first : 20
   search text : "支出負担行為担当官北海道開発局稚内開発建設部長"
   if found :
      set("本官")  
   if not found : 
      search in : all
...
「同種工事（企業）」:
   ...
   if false:
      search in : region_A
      search text : ("平成21年度以降に、次の" , "平成20年度以降に、次の")
      if found : 
         take right : 
            search in : taken
            search text : "を元請として施工した実績を有"
            if found : 
               take left : 
                  store(tempdd)
            search in : taken
            search text : "実績を有すること。"
            if found : 
               take right :
                  search in : taken
...
「同種性が認められる（企業）」temp:
   ...
   if false:
      search in : region_A
      search text : "次のア又はイの要件を満たす工事を元請として施工した実績を有"
      if found : 
         take right : 
            search in : taken
            ...
            if found : 
               take right :
                  search in : taken
                  search text : ("イ より同種性の高い工事" , "イより同種性の高い工事")
                  if found : 
                     take left : 
                        remove whitespaces
                        replace("の施工実績を有すること。" , "")
...
「同種性が認められる（企業）」:
   ...
   if false : 
      search in : region_B
      search text : ("施工能力評価型II型 総合評価方式の評価点" , "施工能力評価型I型① 総合評価方式の評価点" , "施工能力評価型II型 技術者育成型")
      if found : 
         take right : 
            search in : taken
